  ...
  const handleAddToCart = async (productId, quantity = 1) => {
    ...
    try {
      ...
      const res = await axios.post(
        `http://127.0.0.1:8000/user/cart/add/${productId}/`,
        { quantity },
        {
          headers: {
      ...
      <div className="chatbot-popup">
        ...
        <div className="chat-header">
          <div className="header-info">
            <ChatbotIcon />
            <h2 className="logo-text">SnapCart Assistant</h2>
          </div>
        ...
        <div ref={chatBodyRef} className="chat-body">
          <div className="message bot-message">
            ...
            <p className="message-text">
              Hey there 👋<br />I’m your SnapCart shopping assistant.<br />
              Ask me about any product, deals, or categories!
              <br /> I am here to provide insights and suggestion on our product's....
            </p>
          </div>
